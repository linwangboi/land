    ...
    <footer className="border-t border-slate-800 bg-slate-950/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="hidden sm:grid sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12">
          {/* Footer Logo/ title + description + icons */}
          <div className="col-span-1 sm:col-span-3 lg:col-span-2 txt-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-3 sm:space-x-4">
              <a href='#' className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"><BsTwitter className="size-5" /></a>
              <a href='#' className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"><FaGithub className='size-5' /></a>
              <a href="#" className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"><MailIcon className='size-5' /></a>
            </div>
          </div>
          {/* Footer links */}
        ...
        {/* Sub Footer content - always visible */}
